  ...
  return (
    ...
    >
      ...
      <NumberFieldGroup className="flex">
        ...
        <NumberFieldInput className="h-10 w-24 border-t border-b border-gray-200 bg-white text-center text-base text-gray-900 tabular-nums focus:z-1 focus:outline focus:-outline-offset-1 focus:outline-gray-100" />
